...
void motor_move(uint8_t motor_i, int v)
{
    ...
    case MOTOR1:
        if (v > 0)
        {
            ...
            __HAL_TIM_SET_COMPARE(&M1TIM, TIM_CHANNEL_1, abs(v));
        }
        else if (v < 0)
        {
        ...
        else
        {
            HAL_GPIO_WritePin(M1A_GPIO_Port, M1A_Pin, GPIO_PIN_SET);
            HAL_GPIO_WritePin(M1B_GPIO_Port, M1B_Pin, GPIO_PIN_SET);
            __HAL_TIM_SET_COMPARE(&M1TIM, TIM_CHANNEL_1, 0);
        }
        break;
    case MOTOR2:
        if (v > 0)
        {
            ...
            __HAL_TIM_SET_COMPARE(&M2TIM, TIM_CHANNEL_2, abs(v));
        }
        else if (v < 0)
        {
        ...
        else
        {
            HAL_GPIO_WritePin(M2A_GPIO_Port, M2A_Pin, GPIO_PIN_SET);
            HAL_GPIO_WritePin(M2B_GPIO_Port, M2B_Pin, GPIO_PIN_SET);
            __HAL_TIM_SET_COMPARE(&M2TIM, TIM_CHANNEL_2, 0);
        }
        break;
    case MOTOR3:
        if (v > 0)
        {
            ...
            __HAL_TIM_SET_COMPARE(&M3TIM, TIM_CHANNEL_3, abs(v));
        }
        else if (v < 0)
        {
        ...
        else
        {
            HAL_GPIO_WritePin(M3A_GPIO_Port, M3A_Pin, GPIO_PIN_SET);
            HAL_GPIO_WritePin(M3B_GPIO_Port, M3B_Pin, GPIO_PIN_SET);
            __HAL_TIM_SET_COMPARE(&M3TIM, TIM_CHANNEL_3, 0);
        }
        break;
    case MOTOR4:
        if (v > 0)
        {
            ...
            __HAL_TIM_SET_COMPARE(&M4TIM, TIM_CHANNEL_4, abs(v));
        }
        else if (v < 0)
        {
        ...
        else
        {
            HAL_GPIO_WritePin(M4A_GPIO_Port, M4A_Pin, GPIO_PIN_SET);
            HAL_GPIO_WritePin(M4B_GPIO_Port, M4B_Pin, GPIO_PIN_SET);
            __HAL_TIM_SET_COMPARE(&M4TIM, TIM_CHANNEL_4, 0);
        }
        break;
    default:
        break;
